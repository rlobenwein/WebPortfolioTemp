...
João da Silva tem 29 anos, é pós-graduado em Engenharia de Software e deseja ter um site diferenciado dos demais para apresentar seus projetos em um processo seletivo de trainee e atualizá-lo rapidamente. Ele também deseja ter em uma única aplicação acesso ao seu perfil do Linkedin e GitHub.

![joao da silva](https://user-images.githubusercontent.com/81194817/135849176-c65f3832-dcf0-4c51-8c69-3585c45cdfe5.png)

Ana Maria tem 27 anos, recém formada em Ciência da Computação, está procurando emprego e quer mostrar aos empregadores o que já desenvolveu por ordem cronológica para que o recrutador possa ter mais clareza e entender melhor o desenvolvimento pessoal dela. Ela também busca uma aplicação que se conecte com o seu perfil no GitHub e mostre seus repositórios públicos. 

![fernanda silva](https://user-images.githubusercontent.com/81194817/135849173-7f3299d5-002d-416d-8c99-4dd9130f0b28.png) 


Antônio Bandeira tem 54 anos, é gerente do setor de Tecnologia da Informação de uma grande multinacional e está a procura de boas pessoas desenvolvedoras. Ele deseja ter acesso rápido a uma aplicação para visualizar os projetos das pessoas desenvolvedoras que ele for entrevistar, acessar o Linkedin e perfil do GitHub delas e de outras pessoas usuárias. 
...
| Ana Maria            | Trocar experiências com outros pessoas desenvolvedoras em Java                                | adquirir e compartilhar conhecimentos sobre a linguagem                                                                       |
...
| Fernanda Silva       | Organizar seus projetos em ordem cronológica                                                  | para mostrar minha evolução e facilitar o entendimento das pessoas recrutadoras                                               |
| Administrador        | Alterar permissões                                                                            | Permitir que possam administrar contas                                                                                        |
| Antônio Bandeira     | Visualizar projetos                                                                           | Recrutar a Maria José e outras pessoas desenvolvedoras.                                                                       |
